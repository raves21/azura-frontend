...
import { AnimeEpisodesData, Status } from "@/utils/types/animeAnilist";
...
import { animeCancelledStatus, animeCompletedStatus, animeOngoingStatus } from "@/utils/variables/anime";
              ...
              <InfoItem
                ...
                infoClassName={
                  ...
                  cn("font-semibold text-orange-500", {
                    "text-green-500": animeOngoingStatus.includes(status as Status),
                    "text-blue-500": animeCompletedStatus.includes(status as Status),
                    "text-red-500": animeCancelledStatus.includes(status as Status),
                  })
                }
              />
