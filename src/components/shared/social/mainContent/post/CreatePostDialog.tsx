...
import { Globe, ChevronDown, X, Smile, Paperclip } from "lucide-react";
...
export default function CreatePostDialog() {
  ...
  return (
    <div className="aspect-[1/1] bg-socialPrimary rounded-lg flex flex-col w-[550px] text-mainWhite">
      ...
      <div className="flex flex-col flex-grow w-full gap-4 p-4">
        <div className="flex items-center w-full gap-3">
          ...
          <div className="space-y-2">
            ...
            <button className="flex items-center rounded-full gap-1 px-2 py-1 bg-gray-800 hover:bg-[#323b4a]">
