...
export default function DescriptionSkeleton({
  ...
  return (
    <div className={cn("relative gap-3 mt-2 w-[75%]", className)}>
      {showDescriptionLabel && (
        <Skeleton className="mb-3 text-lg font-semibold text-transparent bg-gray-800 w-min lg:hidden">
          Description
        </Skeleton>
      )}
      <Skeleton ref={descriptionRef} className="text-transparent bg-gray-800">
