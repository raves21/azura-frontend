...
import AddCollectionItemMediaPreviewContainer from "./AddCollectionItemMediaPreviewContainer";

type Props = {
  media: Media;
};

export default function AddCollectionItemMediaPreviewDialog({ media }: Props) {
  ...
  return (
    <AddCollectionItemMediaPreviewContainer media={media}>
    ...
    </AddCollectionItemMediaPreviewContainer>
  );
}
